...
<div class="container-fluid text-center">    
  	<div class="row content">
    	<div class="col-sm-8 text-center">
    		...
    		<hr>
    		<p>Questa pagina è riservata al personale amministrativo del museo e l'accesso al sistema è consentito solo al personale fornito delle credenziali dall'amministrazione stessa del museo.</p>
    	</div>
    </div>
</div>
</body>
